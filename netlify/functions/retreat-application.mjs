 ...
 * Handles retreat application form submissions and sends email notifications.
 * Endpoint: /.netlify/functions/retreat-application
 */
...
export const handler = async function (event, context) {
  ...
  try {
    ...
    return {
      statusCode: 500,
      body: JSON.stringify({ error: "Failed to send email. Please email shaun@shauntucker.com.au directly." }),
    };
  }
};

...
const STAGES = [
  {
    ...
    subheadline: "But you're still a passenger.",
    body: "You work hard. You provide. You show up. But beneath the performance, you're running on fumes. You're winning the game, but losing the player.",
  ...
  },
  {
    ...
    subheadline: "Change your state, choose your life.",
    body: "You're not broken; you're untempered. The Samurai didn't become great through effort alone—he became great through the science of breath, discipline, and the courage to regulate himself.",
  ...
  },
  {
    ...
    subheadline: "You start architecting.",
    body: "Regulated. Grounded. Unshakeable. When you master your internal state, you master your external reality. Your family feels the shift before you even walk through the door.",
  ...
  },
  {
    id: "samurai",
    number: "04",
    label: "The Authority Architect",
    headline: "Present. Powerful. Sovereign.",
    subheadline: "The man who chooses his life.",
    body: "This is the Modern Samurai. Not a fighter—a force of presence. Your children won't remember your salary; they'll remember the man who stood before them, fully alive and fully there.",
    tag: "YOUR DESTINY",
    image: "/hero-04.jpg",
    accentColor: "#F59E0B",

...
const STAGES = [
  {
    ...
    body: "On paper, you've got it together. But at home? You're barely there. Your kids are growing up. Your partner is drifting. And somewhere deep down, you know — the man you are right now is not the man they'll remember.",
  ...
  },
  {
    ...
    body: "More discipline. More hustle. More pushing through. And you're still reactive. Still disconnected. Still not fully present. The problem was never your effort — it's that nobody ever taught you to regulate the man underneath the performance. That ends here.",
  ...
  },
  {
    ...
    body: "You train with purpose. You breathe with intention. You walk into a room and your family feels it — the calm, the strength, the presence. This is what happens when a man stops performing and starts becoming. Your kids notice before you do.",
  ...
  },
  {
    ...
    subheadline: "The dad they'll talk about for generations.",
    body: "Your kids won't remember your salary. They'll remember whether you were there. I made a promise — to my daughter Kelsey, to my own father, and to every man who ever felt like he was running out of time to get this right. This is that promise made real. This is The Unforgettable Dad.",
    tag: "YOUR DESTINY",
